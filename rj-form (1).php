...
function rj_contact_form() {
    ...
    <form id="rj-contact-form" action="" method="post">
        ...
        <input id="rj-input" type="text" name="name" required>

        <label for="email">Email:</label>
        <input id="rj-input" type="email" name="email" required>

        <label for="mobile">Mobile:</label>
        <input id="rj-input" type="tel" name="mobile" required>

        <label for="description">Description:</label>
        <textarea name="description" required></textarea>

        <input id="rj-btn" type="submit" value="Submit">
    </form>
